...
public class MainContentActivity extends FragmentActivity implements IConstants, OnClickListener {
	...
	protected void onCreate(Bundle arg0) {
		super.onCreate(arg0);
		Log.d("jaylkh", "MainContentActivity");
		Log.e("我是一个牛逼的播放器！", StringHelper.getPingYin("我是一个牛逼的播放器！"));
		DisplayMetrics metric = new DisplayMetrics();//获取设备屏幕分辨率等信息
	...
	@Override
	public void onBackPressed() {//当按下返回键
